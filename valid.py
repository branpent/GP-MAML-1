...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser('GP-MAML')
    ...
    parser.add_argument('--output_folder', type=str, default='./output_GP-MAML/',
    ...
    model_path = './output_GP-MAML/{}_{}_{}way_{}shot_15query_4conv_{}/models/epochs_30000.pt'.format(args.algorithm,
                                                                                                           args.dataset,
                                                                                                      args.num_ways,
                                                                                                      args.num_shots,
                                                                                                       args.note)
    tpn_model_path = './output_GP-MAML/{}_{}_{}way_{}shot_15query_4conv_{}/models/tpn_epochs_30000.pt'.format(args.algorithm,
                                                                                                           args.dataset,
                                                                                                      args.num_ways,
                                                                                                      args.num_shots,
                                                                                                       args.note)
